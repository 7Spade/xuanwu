...
**Version:** 1.1 | **Updated:** 2026-02-26 | **Status:** Active
**Scope:** VS4 / VS5 / VS6 / VS3

> **SSOT refs**: architecture → `docs/logic-overview.md` · data contracts → `docs/schema-definition.md` · persistence → `docs/persistence-model-overview.md`
