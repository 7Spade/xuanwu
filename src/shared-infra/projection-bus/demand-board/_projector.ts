...
/**
 * Called by projection-bus/event-funnel on 'workspace:schedule:proposed'.
 *
 ...
 * Called by projection-bus/event-funnel on 'organization:schedule:assigned'.
 *
 ...
 * Called by projection-bus/event-funnel on 'organization:schedule:completed'.
 * [S2] versionGuardAllows enforced before write.
 */
 ...
 * Called by projection-bus/event-funnel on 'organization:schedule:assignmentCancelled'.
 * [S2] versionGuardAllows enforced before write.
 */
