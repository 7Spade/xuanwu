 ...
 *
 * semantic-graph.slice/consensus-engine ???®Â??±Ë??°È? [D21-I D21-K]
 *
 ...
 *
 * Design contract:
 *   [D21-I] ?®Â??±Ë?Âæ???all tag governance proposals must pass consensus
 *           logic-consistency validation before reaching the BBB layer.
 *   [D21-K] Ë™ûÁæ©Ë°ùÁ?Ë£ÅÊ±∫ ??proposals that would create governance-level
 ...
 *
 * Ê≠§ÂØ¶‰ΩúÂ∑≤‰∫§Â??ÉËÄ?docs/architecture/logic-overview.md [D21-I D21-K]
 */

import type { RelationshipProposal } from '../governance/proposal-stream';
...
// ?Ä?Ä?Ä Public API ?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä
...
export function validateConsensus(
  ...
  // ?Ä?Ä Rule 0: Completeness check ?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä
  ...
  // ?Ä?Ä Rule 1: Duplicate pending check ?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä
  ...
  // ?Ä?Ä Rule 2: Contradictory IS_A reversal check ?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä
  for (const existing of activeProposals) {
    if (existing.proposalId === incoming.proposalId) continue;
    if (
      (existing.status === 'pending' || existing.status === 'approved') &&
  ...
  // ?Ä?Ä Rule 3: Opposing relation type for the same tag pair ?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä
  for (const existing of activeProposals) {
    if (existing.proposalId === incoming.proposalId) continue;
